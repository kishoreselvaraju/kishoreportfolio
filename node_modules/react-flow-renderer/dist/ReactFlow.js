...
var GraphView = function (_a) {
    ...
    return (React__default['default'].createElement(FlowRenderer$1, { onPaneClick: onPaneClick, onPaneContextMenu: onPaneContextMenu, onPaneScroll: onPaneScroll, onElementsRemove: onElementsRemove, deleteKeyCode: deleteKeyCode, selectionKeyCode: selectionKeyCode, multiSelectionKeyCode: multiSelectionKeyCode, elementsSelectable: elementsSelectable, onMove: onMove, onMoveStart: onMoveStart, onMoveEnd: onMoveEnd, zoomOnScroll: zoomOnScroll, zoomOnDoubleClick: zoomOnDoubleClick, panOnScroll: panOnScroll, panOnScrollSpeed: panOnScrollSpeed, panOnScrollMode: panOnScrollMode, paneMoveable: paneMoveable, defaultPosition: defaultPosition, defaultZoom: defaultZoom, translateExtent: translateExtent, onSelectionDragStart: onSelectionDragStart, onSelectionDrag: onSelectionDrag, onSelectionDragStop: onSelectionDragStop, onSelectionContextMenu: onSelectionContextMenu },
        ...
        React__default['default'].createElement(EdgeRenderer$1, { edgeTypes: edgeTypes, onElementClick: onElementClick, connectionLineType: connectionLineType, connectionLineStyle: connectionLineStyle, arrowHeadColor: arrowHeadColor, markerEndId: markerEndId, connectionLineComponent: connectionLineComponent, onlyRenderVisibleElements: onlyRenderVisibleElements })));
};
...
var BaseHandle = function (_a) {
    ...
    return (React__default['default'].createElement("div", __assign({ "data-handleid": handleId, "data-nodeid": nodeId, "data-handlepos": position, className: handleClasses, onMouseDown: function (event) {
...
var BaseHandle$1 = React.memo(BaseHandle);
...
var Handle = function (_a) {
    var _b = _a.type, type = _b === void 0 ? 'source' : _b, _c = _a.position, position = _c === void 0 ? exports.Position.Top : _c, _d = _a.isValidConnection, isValidConnection = _d === void 0 ? function () { return true; } : _d, _e = _a.isConnectable, isConnectable = _e === void 0 ? true : _e, style = _a.style, className = _a.className, id = _a.id, onConnect = _a.onConnect;
...
var wrapNode = (function (NodeComponent) {
    var NodeWrapper = function (_a) {
        ...
        return (React__default['default'].createElement(DraggableCore_1$1, { onStart: onDragStart, onDrag: onDrag, onStop: onDragStop, scale: scale, disabled: !isDraggable, cancel: ".nodrag", nodeRef: nodeElement, grid: grid },
            React__default['default'].createElement("div", { className: nodeClasses, ref: nodeElement, style: nodeStyle, onMouseEnter: onMouseEnterHandler, onMouseMove: onMouseMoveHandler, onMouseLeave: onMouseLeaveHandler, onContextMenu: onContextMenuHandler, onClick: onSelectNodeHandler },
...
var Background = function (_a) {
    ...
    var bgSvgTile = React.useMemo(function () {
    ...
    return (React__default['default'].createElement("div", { className: bgClasses, style: __assign(__assign({}, style), { backgroundImage: "url(\"data:image/svg+xml;utf8," + bgSvgTile + "\")", backgroundPosition: xOffset + "px " + yOffset + "px" }) }));
};
